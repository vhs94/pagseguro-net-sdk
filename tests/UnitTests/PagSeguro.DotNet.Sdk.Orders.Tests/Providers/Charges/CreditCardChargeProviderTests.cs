...
{
    public class CreditCardChargeProviderTests : BaseProviderTests<CreditCardChargeProvider>
    {
        public ChargeByCreditCardResponse ChargeResponse { get; private set; } = null!;

        protected override CreditCardChargeProvider CreateProvider()
        {
            return new CreditCardChargeProvider(Settings, FlurlClientMock);
        }
        ...
        private ChargeByCreditCardResponse CreateChargeResponse()
        {
            return Fixture.Create<ChargeByCreditCardResponse>();
        }
        ...
        {
            return Fixture.Create<CreditCardPaymentMethodRequest>();
        }
        ...
        {
            string referenceId = "referenceId";
            var expectedCharge = new ChargeByCreditCardRequest
            {
        ...
        public void Build_ChargeIsReturned()
        {
            ...
            Provider.WithReferenceId(referenceId);
            ChargeByCreditCardRequest chargeRequest = Provider.Build();

            ChargeByCreditCardRequest secondChargeRequest = Provider.Build();
        ...
        {
            ChargeByCreditCardResponse result = await Provider.ChargeAsync();
        ...
        public async Task GetByIdAsync_ChargeIsValid_HttpRequestIsCreated()
        {
            ...
            ChargeByCreditCardResponse result = await Provider.GetByIdAsync(chargeId);
        ...
        public async Task CancelAsync_ChargeIsValid_HttpRequestIsCreated()
        {
            ...
            ChargeByCreditCardResponse result = await Provider.WithId(chargeId).CancelAsync(100);
        ...
        public async Task CaptureAsync_ChargeIsValid_HttpRequestIsCreated()
        {
            ...
            ChargeByCreditCardResponse result = await Provider
                .WithId(chargeId)
                .CaptureAsync(100);
