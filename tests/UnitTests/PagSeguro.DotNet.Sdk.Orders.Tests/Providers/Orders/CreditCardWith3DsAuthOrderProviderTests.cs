...
{
    public class CreditCardWith3DsAuthOrderProviderTests : BaseProviderTests<ICreditCardWith3DsAuthOrderProvider>
    {
        ...
        protected override ICreditCardWith3DsAuthOrderProvider CreateProvider()
        {
